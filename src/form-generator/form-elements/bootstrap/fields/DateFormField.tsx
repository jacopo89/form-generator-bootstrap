...
import {normalizeDateBootstrap, serializeDateBootstrap} from "../../utils/TimeManager";
...
export default function DateFormField(props:DateElementInterface){
    ...
    const handleData = (value:any) => {
        setFieldValue( serializeDateBootstrap(value))
    }
    ...
    return <div>
        ...
        <DatePicker disabled={disable} placeholderText={placeholder} className="form-control" selected={value ? normalizeDateBootstrap(value): null} onChange={handleData} dateFormat={"dd/MM/yyyy"}/>
