...
export default function TextFormField(props) {
    ...
    return _jsxs(Form.Group, Object.assign({ as: "div", style: { position: "relative" } }, { children: [label !== false && _jsx(Form.Label, { children: label !== null && label !== void 0 ? label : Header }, void 0), _jsx(Form.Control, { isInvalid: nestedTouched && nestedError !== undefined, disabled: disable, type: "text", name: accessor, placeholder: placeholder, value: getNestedValue(accessor, values), onChange: (e) => {
