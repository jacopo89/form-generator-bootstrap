...
export default function NumberFormField(props) {
    ...
    return _jsxs(FormGroup, { children: [label !== false && _jsx(Form.Label, { children: label !== null && label !== void 0 ? label : Header }, void 0), _jsx(Form.Control, { isInvalid: nestedTouched && nestedError !== undefined, type: "number", name: accessor, placeholder: placeholder, value: getNestedValue(accessor, values), onChange: (e) => setFieldValue(parseInt(e.target.value)) }, void 0), _jsx(Form.Control.Feedback, Object.assign({ className: "font-weight-bold", type: "invalid", role: "alert", "aria-label": "from feedback", tooltip: true }, { children: nestedError }), void 0)] }, void 0);
}
