...
export declare function normalizeDate(date: string): moment.Moment;
export declare function serializeDate(date: Date): string;
export declare function getMomentDate(date: Date): moment.Moment;
export declare function normalizeDateBootstrap(date: string): Date;
export declare function serializeDateBootstrap(date: Date): string;
